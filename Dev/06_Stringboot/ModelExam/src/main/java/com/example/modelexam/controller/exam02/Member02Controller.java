...
//    결과를 뷰로(exam02/member/member_id.html) 로 전송해 보세요 (테이블 형태로 출력)
    ...
    public String getMemberAll(Model model) {
        ...
        return "exam02/member/member_all.html"; // 이동할 홈페이지 : member_all.html
    }
...
//    getMemberId() 함수 밑에 추가
    ...
    public String getMemberId(@PathVariable int eno, Model model) {
        ...
        return "exam02/member/member_id.html"; // 이동할 홈페이지 : member_id.html
    }
}
