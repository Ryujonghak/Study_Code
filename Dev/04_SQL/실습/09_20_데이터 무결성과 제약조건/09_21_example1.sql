...
ALTER TABLE EMP_SAMPLE DROP PRIMARY KEY CASCADE;

ALTER TABLE EMP_SAMPLE DROP FOREIGN KEY CASCADE;
...
ALTER TABLE DEPT_SAMPLE DROP PRIMARY KEY CASCADE;

ALTER TABLE EMP_SAMPLE ADD CONSTRAINT FK_MY_DEPT_EMP FOREIGN KEY(DNO) REFERENCES DEPARTMENT;